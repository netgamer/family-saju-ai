...
// Month pillars follow approximate 절기 boundaries rather than ordinary
// calendar-month boundaries. The UI continues to disclose that this is
// reference-only and not a professional 만세력 calculation.
